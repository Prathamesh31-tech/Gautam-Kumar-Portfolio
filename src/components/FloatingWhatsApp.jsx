  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 flex flex-col gap-3 items-center">
      ...
      <a
        ...
        className="w-12 h-12 rounded-full bg-[#cfa856] hover:bg-[#dfb864] text-black shadow-xl flex items-center justify-center transition-all duration-300 transform hover:scale-110 active:scale-95 border border-white/20 shadow-[#cfa856]/20"
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="w-12 h-12 rounded-full bg-[#25D366] hover:bg-[#20bd5a] text-black shadow-xl shadow-[#25D366]/30 flex items-center justify-center transition-all duration-300 transform hover:scale-110 active:scale-95 border border-white/20"
