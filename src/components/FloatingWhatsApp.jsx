...
export default function FloatingWhatsApp() {
  return (
    <div className="fixed bottom-6 right-6 xl:bottom-8 xl:right-8 2xl:bottom-10 2xl:right-10 z-40 flex flex-col gap-3 xl:gap-4 items-center">
      
      {/* Phone Call Floating Icon */}
      <a
        href="tel:+919892125720"
        className="w-12 h-12 xl:w-14 xl:h-14 2xl:w-16 2xl:h-16 rounded-full bg-[#cfa856] hover:bg-[#dfb864] text-black shadow-xl flex items-center justify-center transition-all duration-300 transform hover:scale-110 active:scale-95 border border-white/20 shadow-[#cfa856]/20"
        title="Call Now (+91 98921 25720)"
      >
        <Phone className="w-5 h-5 xl:w-6 xl:h-6 2xl:w-7 2xl:h-7 fill-black" />
      </a>
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="w-12 h-12 xl:w-14 xl:h-14 2xl:w-16 2xl:h-16 rounded-full bg-[#25D366] hover:bg-[#20bd5a] text-black shadow-xl shadow-[#25D366]/30 flex items-center justify-center transition-all duration-300 transform hover:scale-110 active:scale-95 border border-white/20"
        title="Chat on WhatsApp (+91 98921 25720)"
      >
        <svg className="w-6 h-6 xl:w-7 xl:h-7 2xl:w-8 2xl:h-8 fill-black" viewBox="0 0 24 24">
