  ...
  return (
    ...
    >
      ...
      <div className="w-full px-6 sm:px-10 lg:px-16 2xl:px-24 3xl:px-32 flex items-center justify-between">
        ...
        <a 
          href="#home" 
          className="group flex items-center gap-1.5 font-serif text-lg sm:text-xl xl:text-2xl 2xl:text-3xl tracking-[0.18em] uppercase font-black"
          title="Gautam Kumar"
        >
        ...
        <nav className="hidden md:flex items-center justify-center gap-7 lg:gap-8 xl:gap-10 2xl:gap-14 text-[11px] xl:text-xs 2xl:text-sm 3xl:text-base font-bold tracking-[0.18em] text-slate-300 uppercase mx-auto">
        ...
        {/* Right Social Icons */}
        <div className="flex items-center gap-5 xl:gap-7 text-slate-300">
          <a 
            ...
            title="Instagram"
          >
            <Instagram className="w-5 h-5 xl:w-6 xl:h-6 2xl:w-7 2xl:h-7" />
          </a>
          ...
          <a 
            ...
            title="LinkedIn"
          >
            <Linkedin className="w-5 h-5 xl:w-6 xl:h-6 2xl:w-7 2xl:h-7" />
          </a>
          ...
          >
            <svg className="w-5 h-5 xl:w-6 xl:h-6 2xl:w-7 2xl:h-7 fill-current" viewBox="0 0 24 24">
