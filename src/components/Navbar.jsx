  ...
  return (
    <header 
      className={`fixed top-0 left-0 right-0 z-40 transition-all duration-300 ${
        isScrolled 
          ? 'bg-black/90 backdrop-blur-md border-b border-white/10 shadow-2xl py-4' 
    ...
    >
      ...
      <div className="w-full px-6 sm:px-10 lg:px-16 flex items-center justify-between">
        ...
        <a 
          href="#home" 
          className="group flex items-center gap-1.5 font-serif text-lg sm:text-xl tracking-[0.18em] uppercase font-black"
          title="Gautam Kumar"
        >
        ...
        <nav className="hidden md:flex items-center justify-center gap-7 lg:gap-8 text-[11px] font-bold tracking-[0.18em] text-slate-300 uppercase mx-auto">
          ...
          >
            ABOUT
            {activeSection === 'home' && (
              <span className="absolute -bottom-2 left-1/2 -translate-x-1/2 w-1.5 h-1.5 rounded-full bg-[#cfa856]"></span>
            )}
          </a>
