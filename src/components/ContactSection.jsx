  ...
  return (
    <section id="contact" className="pt-12 sm:pt-16 pb-16 bg-[#000000] text-slate-100 relative overflow-hidden select-none border-t border-white/5">
      ...
      <div className="w-full px-5 sm:px-10 lg:px-14 xl:px-16 2xl:px-24 3xl:px-32 relative z-10">
        ...
        <div className="max-w-5xl xl:max-w-6xl 2xl:max-w-7xl 3xl:max-w-[1700px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10 xl:gap-14 items-start">
          
          {/* Left Column: Direct Contact Info List */}
          <ScrollReveal delay={100} className="lg:col-span-5 space-y-7 xl:space-y-9 pt-2">
            ...
            <div className="flex items-start gap-4 xl:gap-5">
              <div className="w-11 h-11 xl:w-14 xl:h-14 2xl:w-16 2xl:h-16 rounded-full bg-[#cfa856]/10 border border-[#cfa856]/40 flex items-center justify-center text-[#cfa856] shrink-0 mt-0.5 shadow-lg">
                <MapPin className="w-5 h-5 xl:w-6 xl:h-6 2xl:w-7 2xl:h-7" />
              </div>
              <div className="space-y-1">
                <div className="text-[11px] xl:text-xs 2xl:text-sm font-mono text-[#cfa856] uppercase tracking-widest font-bold">
                  LOCATION
                </div>
                <h3 className="text-base sm:text-lg xl:text-xl 2xl:text-2xl font-bold font-sans text-white">
                  Yashwant Gaurav, Nala Sopara
                </h3>
                <p className="text-xs sm:text-sm xl:text-base 2xl:text-lg text-slate-300 font-mono">
            ...
            <div className="flex items-start gap-4 xl:gap-5">
              <div className="w-11 h-11 xl:w-14 xl:h-14 2xl:w-16 2xl:h-16 rounded-full bg-[#cfa856]/10 border border-[#cfa856]/40 flex items-center justify-center text-[#cfa856] shrink-0 mt-0.5 shadow-lg">
                <Phone className="w-5 h-5 xl:w-6 xl:h-6 2xl:w-7 2xl:h-7" />
              </div>
              <div className="space-y-1">
                <div className="text-[11px] xl:text-xs 2xl:text-sm font-mono text-[#cfa856] uppercase tracking-widest font-bold">
                  PHONE NUMBERS
                </div>
                <div className="space-y-1 font-mono text-sm sm:text-base xl:text-lg 2xl:text-xl font-bold">
                  <div>
            ...
            <div className="flex items-start gap-4 xl:gap-5">
              <div className="w-11 h-11 xl:w-14 xl:h-14 2xl:w-16 2xl:h-16 rounded-full bg-[#cfa856]/10 border border-[#cfa856]/40 flex items-center justify-center text-[#cfa856] shrink-0 mt-0.5 shadow-lg">
                <Mail className="w-5 h-5 xl:w-6 xl:h-6 2xl:w-7 2xl:h-7" />
              </div>
              <div className="space-y-1">
                <div className="text-[11px] xl:text-xs 2xl:text-sm font-mono text-[#cfa856] uppercase tracking-widest font-bold">
                  EMAIL ADDRESSES
                </div>
                <div className="space-y-1 font-mono text-xs sm:text-sm xl:text-base 2xl:text-lg font-semibold">
                  <div>
          ...
          <ScrollReveal delay={200} className="lg:col-span-7">
            <div className="space-y-5 xl:space-y-7">
              ...
              <div>
                <h3 className="text-xl sm:text-2xl xl:text-3xl font-bold font-sans text-white uppercase tracking-wide">
                  SEND A DIRECT MESSAGE
                </h3>
                <p className="text-xs sm:text-sm xl:text-base text-slate-400 font-normal pt-1">
                  Fill out the details below and Gautam will get back to you within 24 hours.
                </p>
              </div>

              {isSubmitted ? (
                <div className="p-6 xl:p-8 rounded-xl bg-emerald-500/10 border border-emerald-500/40 text-center space-y-2 animate-fadeIn">
                  <CheckCircle2 className="w-10 h-10 xl:w-12 xl:h-12 text-emerald-400 mx-auto" />
                  <h4 className="text-base sm:text-lg xl:text-xl font-bold text-white font-sans">MESSAGE SENT SUCCESSFULLY!</h4>
                  <p className="text-xs sm:text-sm xl:text-base text-emerald-300 font-mono">
                ...
                <form onSubmit={handleSubmit} className="space-y-4 xl:space-y-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 xl:gap-6">
                    ...
                    <div className="space-y-1.5 xl:space-y-2">
                      <label className="text-xs xl:text-sm font-mono text-slate-300 uppercase tracking-wider">
                        YOUR FULL NAME *
                      </label>
                      <input
                        type="text"
                        ...
                        className="w-full px-4 xl:px-5 py-3 xl:py-4 rounded-xl bg-white/5 border border-white/10 text-white placeholder-slate-500 focus:outline-none focus:border-[#cfa856] text-xs sm:text-sm xl:text-base font-sans transition-colors"
                      />
                    </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 xl:gap-6">
                    ...
                    <div className="space-y-1.5 xl:space-y-2">
                      ...
                      <select
                        ...
                        className="w-full px-4 xl:px-5 py-3 xl:py-4 rounded-xl bg-[#141419] border border-white/10 text-white focus:outline-none focus:border-[#cfa856] text-xs sm:text-sm xl:text-base font-sans transition-colors"
                      >
                  ...
                  <div className="space-y-1.5 xl:space-y-2">
                    ...
                    <textarea
                      ...
                      className="w-full px-4 xl:px-5 py-3 xl:py-4 rounded-xl bg-white/5 border border-white/10 text-white placeholder-slate-500 focus:outline-none focus:border-[#cfa856] text-xs sm:text-sm xl:text-base font-sans transition-colors resize-none"
                    />
                  </div>
                  ...
                  <button
                    type="submit"
                    className="w-full py-3.5 xl:py-4.5 rounded-xl bg-[#cfa856] hover:bg-[#dfb864] text-black font-bold font-mono text-xs xl:text-sm 2xl:text-base tracking-widest uppercase flex items-center justify-center gap-2 shadow-lg shadow-[#cfa856]/20 transition-all transform hover:-translate-y-0.5 active:scale-95"
                  >
                    <Send className="w-4 h-4 xl:w-5 xl:h-5 fill-black" />
